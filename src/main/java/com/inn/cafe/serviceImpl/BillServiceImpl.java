...
public class BillServiceImpl implements BillService {
    ...
    public ResponseEntity<String> generateReport(Map<String, Object> requestMap) {
        ...
        try {
            ...
            if (validateRequestMap(requestMap)) {
                ...
                Paragraph chunk = new Paragraph("Cafe Management System", gentFont("Header"));
    ...
    private Font gentFont(String type) {
        log.info("Inside getFont");
        switch (type) {
            case "Header":
                Font headerFont = getFont(FontFactory.HELVETICA_BOLDOBLIQUE, 18, BaseColor.BLACK);
                headerFont.setStyle(Font.BOLD);
                return headerFont;
            case "Data":
                Font dataFont = getFont(FontFactory.TIMES_ROMAN, 11, BaseColor.BLACK);
